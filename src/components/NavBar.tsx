...
import { faAlignJustify, faArrowLeft, faTimes } from "@fortawesome/free-solid-svg-icons";
...
const NavBar = () => {
    ...
    return (
        <>
            {showNav && (<div className="lg:hidden absolute top-0 rounded-bl-full z-10" style={{ height: "100vh", width: "100vw", backgroundColor: "#3A2837" }}>
